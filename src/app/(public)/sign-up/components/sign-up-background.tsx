...
export function SignUpBackground({ children }: SignUpBackgroundProps) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 via-emerald-50/30 to-teal-50/50 dark:from-[#151515] dark:via-emerald-950/15 dark:to-[#1A1A1A] px-4 py-12 relative overflow-hidden">
